...
<body>
	...
	<div id="page-title">
		...
		<div id="page-title-inner">
			...
			<div class="container">
				...
				<h2><i class="ico-stats ico-white"></i>Galeri</h2>
	...
	<div id="wrapper">
		...
		<!--start: Container -->
    	<div class="container"> 
        <center><div class="title" style="margin-left: ;"><h3>GALERI</h3></div></center>
            <div class="col">
                            <div class="row-md-4 col-ms-6">
                                <div class="g-item">
                                    <img src="<?php echo base_url('asset/images/gallery/g1.jpg'); ?>" alt="">
            ...
            <div class="col">
                            <div class="row-md-4 col-ms-6">
                                <div class="g-item">
                                    <img src="<?php echo base_url('asset/images/gallery/g4.jpg'); ?>" alt="">
